# io.kubernetes.csharp.Api.StorageV1beta1Api
...
# **CreateStorageClass**
> V1beta1StorageClass CreateStorageClass (V1beta1StorageClass body, string pretty = null)
...
namespace Example
{
    public class CreateStorageClassExample
    {
        public void main()
        {
            ...
            var apiInstance = new StorageV1beta1Api();
            var body = new V1beta1StorageClass(); // V1beta1StorageClass | 
            ...
            {
                Debug.Print("Exception when calling StorageV1beta1Api.CreateStorageClass: " + e.Message );
            }
        }
    }
}
...
> UnversionedStatus DeleteCollectionStorageClass (string pretty = null, string fieldSelector = null, string labelSelector = null, string resourceVersion = null, int? timeoutSeconds = null, bool? watch = null)
...
namespace Example
{
    public class DeleteCollectionStorageClassExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling StorageV1beta1Api.DeleteCollectionStorageClass: " + e.Message );
            }
        }
    }
}
...
# **DeleteStorageClass**
> UnversionedStatus DeleteStorageClass (string name, V1DeleteOptions body, string pretty = null, int? gracePeriodSeconds = null, bool? orphanDependents = null)
...
namespace Example
{
    public class DeleteStorageClassExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling StorageV1beta1Api.DeleteStorageClass: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class GetAPIResourcesExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling StorageV1beta1Api.GetAPIResources: " + e.Message );
            }
        }
    }
}
...
# **ListStorageClass**
> V1beta1StorageClassList ListStorageClass (string pretty = null, string fieldSelector = null, string labelSelector = null, string resourceVersion = null, int? timeoutSeconds = null, bool? watch = null)
...
namespace Example
{
    public class ListStorageClassExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling StorageV1beta1Api.ListStorageClass: " + e.Message );
            }
        }
    }
}
...
# **PatchStorageClass**
> V1beta1StorageClass PatchStorageClass (string name, UnversionedPatch body, string pretty = null)
...
namespace Example
{
    public class PatchStorageClassExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling StorageV1beta1Api.PatchStorageClass: " + e.Message );
            }
        }
    }
}
...
# **ReadStorageClass**
> V1beta1StorageClass ReadStorageClass (string name, string pretty = null, bool? exact = null, bool? export = null)
...
namespace Example
{
    public class ReadStorageClassExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling StorageV1beta1Api.ReadStorageClass: " + e.Message );
            }
        }
    }
}
...
# **ReplaceStorageClass**
> V1beta1StorageClass ReplaceStorageClass (string name, V1beta1StorageClass body, string pretty = null)
...
namespace Example
{
    public class ReplaceStorageClassExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling StorageV1beta1Api.ReplaceStorageClass: " + e.Message );
            }
        }
    }
}
