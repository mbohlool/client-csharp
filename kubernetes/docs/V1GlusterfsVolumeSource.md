# io.kubernetes.csharp.Model.V1GlusterfsVolumeSource
## Properties
...
**_ReadOnly** | **bool?** | ReadOnly here will force the Glusterfs volume to be mounted with read-only permissions. Defaults to false. More info: http://releases.k8s.io/HEAD/examples/volumes/glusterfs/README.md#create-a-pod | [optional] 
