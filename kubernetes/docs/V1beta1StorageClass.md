# io.kubernetes.csharp.Model.V1beta1StorageClass
## Properties
...
**Parameters** | **Dictionary&lt;string, string&gt;** | Parameters holds the parameters for the provisioner that should create volumes of this storage class. | [optional] 
