...
namespace io.kubernetes.csharp.Api
{
    ...
    /// </summary>
    public interface IAutoscalingApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class AutoscalingApi : IAutoscalingApi
    {
        private io.kubernetes.csharp.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="AutoscalingApi"/> class.
        /// </summary>
        /// <returns></returns>
        public AutoscalingApi(String basePath)
        {
        ...
        /// <returns></returns>
        public AutoscalingApi(Configuration configuration = null)
        {
        ...
        public ApiResponse< UnversionedAPIGroup > GetAPIGroupWithHttpInfo ()
        {
            ...
            var localVarPath = "/apis/autoscaling/";
