...
namespace io.kubernetes.csharp.Client
{
    ...
    public class Configuration
    {
        ...
        public Configuration(ApiClient apiClient = null,
                             ...
                             int timeout = 100000,
                             string userAgent = "Swagger-Codegen/1.0.0-snapshot/csharp"
                            )
        {
        ...
        public const string Version = "1.0.0-snapshot";
        ...
        {
            String report = "C# SDK (io.kubernetes.csharp) Debug Report:\n";
            report += "    OS: " + Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + Assembly
                     .GetExecutingAssembly()
                     .GetReferencedAssemblies()
                     .Where(x => x.Name == "System.Core").First().Version.ToString()  + "\n";
            report += "    Version of the API: v1.5.1-660c2a2\n";
            report += "    SDK Package Version: 1.0.0-snapshot\n";
