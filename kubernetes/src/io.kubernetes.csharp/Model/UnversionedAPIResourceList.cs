...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UnversionedAPIResourceList :  IEquatable<UnversionedAPIResourceList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UnversionedAPIResourceList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UnversionedAPIResourceList() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UnversionedAPIResourceList" /> class.
        /// </summary>
        ...
        public UnversionedAPIResourceList(string ApiVersion = default(string), string GroupVersion = default(string), string Kind = default(string), List<UnversionedAPIResource> Resources = default(List<UnversionedAPIResource>))
        {
            // to ensure "GroupVersion" is required (not null)
            if (GroupVersion == null)
            {
                throw new InvalidDataException("GroupVersion is a required property for UnversionedAPIResourceList and cannot be null");
            }
            else
            {
            ...
            if (Resources == null)
            {
                throw new InvalidDataException("Resources is a required property for UnversionedAPIResourceList and cannot be null");
            }
            else
            {
        ...
        public List<UnversionedAPIResource> Resources { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UnversionedAPIResourceList);
        }

        /// <summary>
        /// Returns true if UnversionedAPIResourceList instances are equal
        /// </summary>
        /// <param name="other">Instance of UnversionedAPIResourceList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UnversionedAPIResourceList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
