...
namespace io.kubernetes.csharp.Model
{
    ...
    public partial class V1AzureDiskVolumeSource :  IEquatable<V1AzureDiskVolumeSource>, IValidatableObject
    {
        ...
        public V1AzureDiskVolumeSource(string CachingMode = default(string), string DiskName = default(string), string DiskURI = default(string), string FsType = default(string), bool? _ReadOnly = default(bool?))
        {
