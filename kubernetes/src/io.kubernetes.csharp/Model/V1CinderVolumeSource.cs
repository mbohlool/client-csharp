...
namespace io.kubernetes.csharp.Model
{
    ...
    public partial class V1CinderVolumeSource :  IEquatable<V1CinderVolumeSource>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="V1CinderVolumeSource" /> class.
        /// </summary>
        /// <param name="FsType">Filesystem type to mount. Must be a filesystem type supported by the host operating system. Examples: \&quot;ext4\&quot;, \&quot;xfs\&quot;, \&quot;ntfs\&quot;. Implicitly inferred to be \&quot;ext4\&quot; if unspecified. More info: http://releases.k8s.io/HEAD/examples/mysql-cinder-pd/README.md.</param>
        /// <param name="_ReadOnly">Optional: Defaults to false (read/write). ReadOnly here will force the ReadOnly setting in VolumeMounts. More info: http://releases.k8s.io/HEAD/examples/mysql-cinder-pd/README.md.</param>
        /// <param name="VolumeID">volume id used to identify the volume in cinder More info: http://releases.k8s.io/HEAD/examples/mysql-cinder-pd/README.md (required).</param>
