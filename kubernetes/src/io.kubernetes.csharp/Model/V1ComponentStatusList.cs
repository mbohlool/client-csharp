...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1ComponentStatusList :  IEquatable<V1ComponentStatusList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1ComponentStatusList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1ComponentStatusList() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1ComponentStatusList" /> class.
        /// </summary>
        ...
        /// <param name="Items">List of ComponentStatus objects. (required).</param>
        ...
        public V1ComponentStatusList(string ApiVersion = default(string), List<V1ComponentStatus> Items = default(List<V1ComponentStatus>), string Kind = default(string), UnversionedListMeta Metadata = default(UnversionedListMeta))
        {
            // to ensure "Items" is required (not null)
            if (Items == null)
            {
                throw new InvalidDataException("Items is a required property for V1ComponentStatusList and cannot be null");
            }
            else
            {
                this.Items = Items;
        ...
        /// </summary>
        /// <value>List of ComponentStatus objects.</value>
        [DataMember(Name="items", EmitDefaultValue=false)]
        public List<V1ComponentStatus> Items { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1ComponentStatusList);
        }

        /// <summary>
        /// Returns true if V1ComponentStatusList instances are equal
        /// </summary>
        /// <param name="other">Instance of V1ComponentStatusList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1ComponentStatusList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
