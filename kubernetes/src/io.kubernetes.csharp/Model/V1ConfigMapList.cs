...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1ConfigMapList :  IEquatable<V1ConfigMapList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1ConfigMapList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1ConfigMapList() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1ConfigMapList" /> class.
        /// </summary>
        ...
        /// <param name="Items">Items is the list of ConfigMaps. (required).</param>
        ...
        /// <param name="Metadata">More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#metadata.</param>
        public V1ConfigMapList(string ApiVersion = default(string), List<V1ConfigMap> Items = default(List<V1ConfigMap>), string Kind = default(string), UnversionedListMeta Metadata = default(UnversionedListMeta))
        {
            // to ensure "Items" is required (not null)
            if (Items == null)
            {
                throw new InvalidDataException("Items is a required property for V1ConfigMapList and cannot be null");
            }
            else
            {
                this.Items = Items;
        ...
        /// </summary>
        /// <value>Items is the list of ConfigMaps.</value>
        [DataMember(Name="items", EmitDefaultValue=false)]
        public List<V1ConfigMap> Items { get; set; }
        /// <summary>
        ...
        /// </summary>
        /// <value>More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#metadata</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1ConfigMapList);
        }

        /// <summary>
        /// Returns true if V1ConfigMapList instances are equal
        /// </summary>
        /// <param name="other">Instance of V1ConfigMapList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1ConfigMapList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
