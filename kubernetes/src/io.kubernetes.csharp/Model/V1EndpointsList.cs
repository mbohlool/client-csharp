...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1EndpointsList :  IEquatable<V1EndpointsList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1EndpointsList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1EndpointsList() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1EndpointsList" /> class.
        /// </summary>
        ...
        /// <param name="Items">List of endpoints. (required).</param>
        ...
        public V1EndpointsList(string ApiVersion = default(string), List<V1Endpoints> Items = default(List<V1Endpoints>), string Kind = default(string), UnversionedListMeta Metadata = default(UnversionedListMeta))
        {
            // to ensure "Items" is required (not null)
            if (Items == null)
            {
                throw new InvalidDataException("Items is a required property for V1EndpointsList and cannot be null");
            }
            else
            {
                this.Items = Items;
        ...
        public List<V1Endpoints> Items { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1EndpointsList);
        }

        /// <summary>
        /// Returns true if V1EndpointsList instances are equal
        /// </summary>
        /// <param name="other">Instance of V1EndpointsList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1EndpointsList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
