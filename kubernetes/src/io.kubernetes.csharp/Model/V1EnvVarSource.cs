...
namespace io.kubernetes.csharp.Model
{
    ...
    public partial class V1EnvVarSource :  IEquatable<V1EnvVarSource>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>Selects a field of the pod: supports metadata.name, metadata.namespace, metadata.labels, metadata.annotations, spec.nodeName, spec.serviceAccountName, status.podIP.</value>
