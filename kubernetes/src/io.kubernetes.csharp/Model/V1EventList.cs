...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1EventList :  IEquatable<V1EventList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1EventList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1EventList() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1EventList" /> class.
        /// </summary>
        ...
        /// <param name="Items">List of events (required).</param>
        ...
        public V1EventList(string ApiVersion = default(string), List<V1Event> Items = default(List<V1Event>), string Kind = default(string), UnversionedListMeta Metadata = default(UnversionedListMeta))
        {
            // to ensure "Items" is required (not null)
            if (Items == null)
            {
                throw new InvalidDataException("Items is a required property for V1EventList and cannot be null");
            }
            else
            {
                this.Items = Items;
        ...
        /// List of events
        /// </summary>
        /// <value>List of events</value>
        [DataMember(Name="items", EmitDefaultValue=false)]
        public List<V1Event> Items { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1EventList);
        }

        /// <summary>
        /// Returns true if V1EventList instances are equal
        /// </summary>
        /// <param name="other">Instance of V1EventList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1EventList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
