...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1HorizontalPodAutoscaler :  IEquatable<V1HorizontalPodAutoscaler>, IValidatableObject
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1HorizontalPodAutoscaler);
        }

        /// <summary>
        /// Returns true if V1HorizontalPodAutoscaler instances are equal
        /// </summary>
        /// <param name="other">Instance of V1HorizontalPodAutoscaler to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1HorizontalPodAutoscaler other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
