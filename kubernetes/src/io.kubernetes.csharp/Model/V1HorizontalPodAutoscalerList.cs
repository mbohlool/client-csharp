...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1HorizontalPodAutoscalerList :  IEquatable<V1HorizontalPodAutoscalerList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1HorizontalPodAutoscalerList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1HorizontalPodAutoscalerList() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1HorizontalPodAutoscalerList" /> class.
        /// </summary>
        ...
        public V1HorizontalPodAutoscalerList(string ApiVersion = default(string), List<V1HorizontalPodAutoscaler> Items = default(List<V1HorizontalPodAutoscaler>), string Kind = default(string), UnversionedListMeta Metadata = default(UnversionedListMeta))
        {
            // to ensure "Items" is required (not null)
            if (Items == null)
            {
                throw new InvalidDataException("Items is a required property for V1HorizontalPodAutoscalerList and cannot be null");
            }
            else
            {
                this.Items = Items;
        ...
        public List<V1HorizontalPodAutoscaler> Items { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1HorizontalPodAutoscalerList);
        }

        /// <summary>
        /// Returns true if V1HorizontalPodAutoscalerList instances are equal
        /// </summary>
        /// <param name="other">Instance of V1HorizontalPodAutoscalerList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1HorizontalPodAutoscalerList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
