...
namespace io.kubernetes.csharp.Model
{
    ...
    public partial class V1HorizontalPodAutoscalerStatus :  IEquatable<V1HorizontalPodAutoscalerStatus>, IValidatableObject
    {
        ...
        public V1HorizontalPodAutoscalerStatus(int? CurrentCPUUtilizationPercentage = default(int?), int? CurrentReplicas = default(int?), int? DesiredReplicas = default(int?), UnversionedTime LastScaleTime = default(UnversionedTime), long? ObservedGeneration = default(long?))
        {
