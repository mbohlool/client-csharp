...
namespace io.kubernetes.csharp.Model
{
    ...
    public partial class V1JobCondition :  IEquatable<V1JobCondition>, IValidatableObject
    {
        ...
        public V1JobCondition(UnversionedTime LastProbeTime = default(UnversionedTime), UnversionedTime LastTransitionTime = default(UnversionedTime), string Message = default(string), string Reason = default(string), string Status = default(string), string Type = default(string))
        {
