...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1JobList :  IEquatable<V1JobList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1JobList" /> class.
        /// </summary>
        ...
        public V1JobList(string ApiVersion = default(string), List<V1Job> Items = default(List<V1Job>), string Kind = default(string), UnversionedListMeta Metadata = default(UnversionedListMeta))
        {
            // to ensure "Items" is required (not null)
            if (Items == null)
            {
                throw new InvalidDataException("Items is a required property for V1JobList and cannot be null");
            }
            else
            {
                this.Items = Items;
        ...
        public List<V1Job> Items { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1JobList);
        }

        /// <summary>
        /// Returns true if V1JobList instances are equal
        /// </summary>
        /// <param name="other">Instance of V1JobList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1JobList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
