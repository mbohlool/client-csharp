...
namespace io.kubernetes.csharp.Model
{
    ...
    public partial class V1JobStatus :  IEquatable<V1JobStatus>, IValidatableObject
    {
        ...
        public V1JobStatus(int? Active = default(int?), UnversionedTime CompletionTime = default(UnversionedTime), List<V1JobCondition> Conditions = default(List<V1JobCondition>), int? Failed = default(int?), UnversionedTime StartTime = default(UnversionedTime), int? Succeeded = default(int?))
        {
            this.Active = Active;
