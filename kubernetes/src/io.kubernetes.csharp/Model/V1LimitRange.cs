...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1LimitRange :  IEquatable<V1LimitRange>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="Spec">Spec defines the limits enforced. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#spec-and-status.</param>
        ...
        /// </summary>
        /// <value>Spec defines the limits enforced. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#spec-and-status</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1LimitRange);
        }

        /// <summary>
        /// Returns true if V1LimitRange instances are equal
        /// </summary>
        /// <param name="other">Instance of V1LimitRange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1LimitRange other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
