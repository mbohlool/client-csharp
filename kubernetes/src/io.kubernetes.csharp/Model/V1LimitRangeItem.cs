...
namespace io.kubernetes.csharp.Model
{
    ...
    public partial class V1LimitRangeItem :  IEquatable<V1LimitRangeItem>, IValidatableObject
    {
        ...
        public V1LimitRangeItem(Dictionary<string, ResourceQuantity> _Default = default(Dictionary<string, ResourceQuantity>), Dictionary<string, ResourceQuantity> DefaultRequest = default(Dictionary<string, ResourceQuantity>), Dictionary<string, ResourceQuantity> Max = default(Dictionary<string, ResourceQuantity>), Dictionary<string, ResourceQuantity> MaxLimitRequestRatio = default(Dictionary<string, ResourceQuantity>), Dictionary<string, ResourceQuantity> Min = default(Dictionary<string, ResourceQuantity>), string Type = default(string))
        {
        ...
        public Dictionary<string, ResourceQuantity> _Default { get; set; }
        /// <summary>
        ...
        public Dictionary<string, ResourceQuantity> DefaultRequest { get; set; }
        /// <summary>
        /// Max usage constraints on this kind by resource name.
        /// </summary>
        /// <value>Max usage constraints on this kind by resource name.</value>
        [DataMember(Name="max", EmitDefaultValue=false)]
        public Dictionary<string, ResourceQuantity> Max { get; set; }
        /// <summary>
        ...
        public Dictionary<string, ResourceQuantity> MaxLimitRequestRatio { get; set; }
        /// <summary>
        /// Min usage constraints on this kind by resource name.
        /// </summary>
        /// <value>Min usage constraints on this kind by resource name.</value>
        [DataMember(Name="min", EmitDefaultValue=false)]
        public Dictionary<string, ResourceQuantity> Min { get; set; }
        /// <summary>
