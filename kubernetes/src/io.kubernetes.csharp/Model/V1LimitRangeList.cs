...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1LimitRangeList :  IEquatable<V1LimitRangeList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1LimitRangeList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1LimitRangeList() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1LimitRangeList" /> class.
        /// </summary>
        ...
        /// <param name="Items">Items is a list of LimitRange objects. More info: http://releases.k8s.io/HEAD/docs/design/admission_control_limit_range.md (required).</param>
        ...
        public V1LimitRangeList(string ApiVersion = default(string), List<V1LimitRange> Items = default(List<V1LimitRange>), string Kind = default(string), UnversionedListMeta Metadata = default(UnversionedListMeta))
        {
            // to ensure "Items" is required (not null)
            if (Items == null)
            {
                throw new InvalidDataException("Items is a required property for V1LimitRangeList and cannot be null");
            }
            else
            {
                this.Items = Items;
        ...
        /// </summary>
        /// <value>Items is a list of LimitRange objects. More info: http://releases.k8s.io/HEAD/docs/design/admission_control_limit_range.md</value>
        [DataMember(Name="items", EmitDefaultValue=false)]
        public List<V1LimitRange> Items { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1LimitRangeList);
        }

        /// <summary>
        /// Returns true if V1LimitRangeList instances are equal
        /// </summary>
        /// <param name="other">Instance of V1LimitRangeList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1LimitRangeList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
