...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1Namespace :  IEquatable<V1Namespace>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="Spec">Spec defines the behavior of the Namespace. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#spec-and-status.</param>
        /// <param name="Status">Status describes the current status of a Namespace. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#spec-and-status.</param>
        ...
        /// </summary>
        /// <value>Spec defines the behavior of the Namespace. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#spec-and-status</value>
        ...
        /// </summary>
        /// <value>Status describes the current status of a Namespace. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#spec-and-status</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1Namespace);
        }

        /// <summary>
        /// Returns true if V1Namespace instances are equal
        /// </summary>
        /// <param name="other">Instance of V1Namespace to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1Namespace other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
