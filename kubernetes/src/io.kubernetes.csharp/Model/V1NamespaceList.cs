...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1NamespaceList :  IEquatable<V1NamespaceList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1NamespaceList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1NamespaceList() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1NamespaceList" /> class.
        /// </summary>
        ...
        /// <param name="Items">Items is the list of Namespace objects in the list. More info: http://kubernetes.io/docs/user-guide/namespaces (required).</param>
        ...
        public V1NamespaceList(string ApiVersion = default(string), List<V1Namespace> Items = default(List<V1Namespace>), string Kind = default(string), UnversionedListMeta Metadata = default(UnversionedListMeta))
        {
            // to ensure "Items" is required (not null)
            if (Items == null)
            {
                throw new InvalidDataException("Items is a required property for V1NamespaceList and cannot be null");
            }
            else
            {
                this.Items = Items;
        ...
        /// </summary>
        /// <value>Items is the list of Namespace objects in the list. More info: http://kubernetes.io/docs/user-guide/namespaces</value>
        [DataMember(Name="items", EmitDefaultValue=false)]
        public List<V1Namespace> Items { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1NamespaceList);
        }

        /// <summary>
        /// Returns true if V1NamespaceList instances are equal
        /// </summary>
        /// <param name="other">Instance of V1NamespaceList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1NamespaceList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
