...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1Node :  IEquatable<V1Node>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="Spec">Spec defines the behavior of a node. http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#spec-and-status.</param>
        /// <param name="Status">Most recently observed status of the node. Populated by the system. Read-only. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#spec-and-status.</param>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1Node);
        }

        /// <summary>
        /// Returns true if V1Node instances are equal
        /// </summary>
        /// <param name="other">Instance of V1Node to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1Node other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
