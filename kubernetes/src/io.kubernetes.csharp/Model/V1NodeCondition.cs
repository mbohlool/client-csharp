...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1NodeCondition :  IEquatable<V1NodeCondition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1NodeCondition" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1NodeCondition() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1NodeCondition" /> class.
        /// </summary>
        /// <param name="LastHeartbeatTime">Last time we got an update on a given condition..</param>
        ...
        /// <param name="Type">Type of node condition. (required).</param>
        public V1NodeCondition(UnversionedTime LastHeartbeatTime = default(UnversionedTime), UnversionedTime LastTransitionTime = default(UnversionedTime), string Message = default(string), string Reason = default(string), string Status = default(string), string Type = default(string))
        {
            // to ensure "Status" is required (not null)
            if (Status == null)
            {
                throw new InvalidDataException("Status is a required property for V1NodeCondition and cannot be null");
            }
            else
            {
                this.Status = Status;
            ...
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for V1NodeCondition and cannot be null");
            }
            else
            {
                this.Type = Type;
        ...
        public UnversionedTime LastHeartbeatTime { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1NodeCondition);
        }

        /// <summary>
        /// Returns true if V1NodeCondition instances are equal
        /// </summary>
        /// <param name="other">Instance of V1NodeCondition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1NodeCondition other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.LastHeartbeatTime != null)
                    hash = hash * 59 + this.LastHeartbeatTime.GetHashCode();
