...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1NodeList :  IEquatable<V1NodeList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1NodeList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1NodeList() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1NodeList" /> class.
        /// </summary>
        ...
        /// <param name="Items">List of nodes (required).</param>
        ...
        public V1NodeList(string ApiVersion = default(string), List<V1Node> Items = default(List<V1Node>), string Kind = default(string), UnversionedListMeta Metadata = default(UnversionedListMeta))
        {
            // to ensure "Items" is required (not null)
            if (Items == null)
            {
                throw new InvalidDataException("Items is a required property for V1NodeList and cannot be null");
            }
            else
            {
                this.Items = Items;
        ...
        public List<V1Node> Items { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1NodeList);
        }

        /// <summary>
        /// Returns true if V1NodeList instances are equal
        /// </summary>
        /// <param name="other">Instance of V1NodeList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1NodeList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
