...
namespace io.kubernetes.csharp.Model
{
    ...
    public partial class V1NodeStatus :  IEquatable<V1NodeStatus>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="Addresses">List of addresses reachable to the node. Queried from cloud provider, if available. More info: http://releases.k8s.io/HEAD/docs/admin/node.md#node-addresses.</param>
        ...
        /// <param name="Capacity">Capacity represents the total resources of a node. More info: http://kubernetes.io/docs/user-guide/persistent-volumes#capacity for more details..</param>
        /// <param name="Conditions">Conditions is an array of current observed node conditions. More info: http://releases.k8s.io/HEAD/docs/admin/node.md#node-condition.</param>
        ...
        /// <param name="NodeInfo">Set of ids/uuids to uniquely identify the node. More info: http://releases.k8s.io/HEAD/docs/admin/node.md#node-info.</param>
        /// <param name="Phase">NodePhase is the recently observed lifecycle phase of the node. More info: http://releases.k8s.io/HEAD/docs/admin/node.md#node-phase The field is never populated, and now is deprecated..</param>
        ...
        public Dictionary<string, ResourceQuantity> Allocatable { get; set; }
        /// <summary>
        ...
        /// </summary>
        /// <value>Capacity represents the total resources of a node. More info: http://kubernetes.io/docs/user-guide/persistent-volumes#capacity for more details.</value>
        ...
        /// </summary>
        /// <value>NodePhase is the recently observed lifecycle phase of the node. More info: http://releases.k8s.io/HEAD/docs/admin/node.md#node-phase The field is never populated, and now is deprecated.</value>
