...
namespace io.kubernetes.csharp.Model
{
    ...
    public partial class V1ObjectMeta :  IEquatable<V1ObjectMeta>, IValidatableObject
    {
        ...
        public UnversionedTime DeletionTimestamp { get; set; }
        /// <summary>
