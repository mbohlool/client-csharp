...
namespace io.kubernetes.csharp.Model
{
    ...
    public partial class V1ObjectReference :  IEquatable<V1ObjectReference>, IValidatableObject
    {
        ...
        /// <param name="_Namespace">Namespace of the referent. More info: http://kubernetes.io/docs/user-guide/namespaces.</param>
        /// <param name="ResourceVersion">Specific resourceVersion to which this reference is made, if any. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#concurrency-control-and-consistency.</param>
        /// <param name="Uid">UID of the referent. More info: http://kubernetes.io/docs/user-guide/identifiers#uids.</param>
        ...
        /// </summary>
        /// <value>Namespace of the referent. More info: http://kubernetes.io/docs/user-guide/namespaces</value>
