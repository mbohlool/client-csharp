...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1PersistentVolumeClaim :  IEquatable<V1PersistentVolumeClaim>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1PersistentVolumeClaim" /> class.
        /// </summary>
        ...
        /// <param name="Spec">Spec defines the desired characteristics of a volume requested by a pod author. More info: http://kubernetes.io/docs/user-guide/persistent-volumes#persistentvolumeclaims.</param>
        /// <param name="Status">Status represents the current information/status of a persistent volume claim. Read-only. More info: http://kubernetes.io/docs/user-guide/persistent-volumes#persistentvolumeclaims.</param>
        ...
        /// </summary>
        /// <value>Spec defines the desired characteristics of a volume requested by a pod author. More info: http://kubernetes.io/docs/user-guide/persistent-volumes#persistentvolumeclaims</value>
        ...
        /// </summary>
        /// <value>Status represents the current information/status of a persistent volume claim. Read-only. More info: http://kubernetes.io/docs/user-guide/persistent-volumes#persistentvolumeclaims</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1PersistentVolumeClaim);
        }

        /// <summary>
        /// Returns true if V1PersistentVolumeClaim instances are equal
        /// </summary>
        /// <param name="other">Instance of V1PersistentVolumeClaim to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1PersistentVolumeClaim other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
