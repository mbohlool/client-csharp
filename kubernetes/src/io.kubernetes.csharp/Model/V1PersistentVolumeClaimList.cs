...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1PersistentVolumeClaimList :  IEquatable<V1PersistentVolumeClaimList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1PersistentVolumeClaimList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1PersistentVolumeClaimList() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1PersistentVolumeClaimList" /> class.
        /// </summary>
        ...
        /// <param name="Items">A list of persistent volume claims. More info: http://kubernetes.io/docs/user-guide/persistent-volumes#persistentvolumeclaims (required).</param>
        ...
        public V1PersistentVolumeClaimList(string ApiVersion = default(string), List<V1PersistentVolumeClaim> Items = default(List<V1PersistentVolumeClaim>), string Kind = default(string), UnversionedListMeta Metadata = default(UnversionedListMeta))
        {
            // to ensure "Items" is required (not null)
            if (Items == null)
            {
                throw new InvalidDataException("Items is a required property for V1PersistentVolumeClaimList and cannot be null");
            }
            else
            {
                this.Items = Items;
        ...
        /// </summary>
        /// <value>A list of persistent volume claims. More info: http://kubernetes.io/docs/user-guide/persistent-volumes#persistentvolumeclaims</value>
        [DataMember(Name="items", EmitDefaultValue=false)]
        public List<V1PersistentVolumeClaim> Items { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1PersistentVolumeClaimList);
        }

        /// <summary>
        /// Returns true if V1PersistentVolumeClaimList instances are equal
        /// </summary>
        /// <param name="other">Instance of V1PersistentVolumeClaimList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1PersistentVolumeClaimList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
