...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1PersistentVolumeList :  IEquatable<V1PersistentVolumeList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1PersistentVolumeList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1PersistentVolumeList() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1PersistentVolumeList" /> class.
        /// </summary>
        ...
        /// <param name="Items">List of persistent volumes. More info: http://kubernetes.io/docs/user-guide/persistent-volumes (required).</param>
        ...
        public V1PersistentVolumeList(string ApiVersion = default(string), List<V1PersistentVolume> Items = default(List<V1PersistentVolume>), string Kind = default(string), UnversionedListMeta Metadata = default(UnversionedListMeta))
        {
            // to ensure "Items" is required (not null)
            if (Items == null)
            {
                throw new InvalidDataException("Items is a required property for V1PersistentVolumeList and cannot be null");
            }
            else
            {
                this.Items = Items;
        ...
        /// </summary>
        /// <value>List of persistent volumes. More info: http://kubernetes.io/docs/user-guide/persistent-volumes</value>
        [DataMember(Name="items", EmitDefaultValue=false)]
        public List<V1PersistentVolume> Items { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1PersistentVolumeList);
        }

        /// <summary>
        /// Returns true if V1PersistentVolumeList instances are equal
        /// </summary>
        /// <param name="other">Instance of V1PersistentVolumeList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1PersistentVolumeList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
