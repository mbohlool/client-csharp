...
namespace io.kubernetes.csharp.Model
{
    ...
    public partial class V1PersistentVolumeStatus :  IEquatable<V1PersistentVolumeStatus>, IValidatableObject
    {
        ...
        /// <param name="Phase">Phase indicates if a volume is available, bound to a claim, or released by a claim. More info: http://kubernetes.io/docs/user-guide/persistent-volumes#phase.</param>
        ...
        /// </summary>
        /// <value>Phase indicates if a volume is available, bound to a claim, or released by a claim. More info: http://kubernetes.io/docs/user-guide/persistent-volumes#phase</value>
