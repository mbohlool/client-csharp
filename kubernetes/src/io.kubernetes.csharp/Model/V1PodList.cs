...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1PodList :  IEquatable<V1PodList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1PodList" /> class.
        /// </summary>
        ...
        /// <param name="Items">List of pods. More info: http://kubernetes.io/docs/user-guide/pods (required).</param>
        ...
        public V1PodList(string ApiVersion = default(string), List<V1Pod> Items = default(List<V1Pod>), string Kind = default(string), UnversionedListMeta Metadata = default(UnversionedListMeta))
        {
            // to ensure "Items" is required (not null)
            if (Items == null)
            {
                throw new InvalidDataException("Items is a required property for V1PodList and cannot be null");
            }
            else
            {
                this.Items = Items;
        ...
        /// </summary>
        /// <value>List of pods. More info: http://kubernetes.io/docs/user-guide/pods</value>
        [DataMember(Name="items", EmitDefaultValue=false)]
        public List<V1Pod> Items { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1PodList);
        }

        /// <summary>
        /// Returns true if V1PodList instances are equal
        /// </summary>
        /// <param name="other">Instance of V1PodList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1PodList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
