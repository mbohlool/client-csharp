...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1PodTemplate :  IEquatable<V1PodTemplate>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="Template">Template defines the pods that will be created from this pod template. http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#spec-and-status.</param>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1PodTemplate);
        }

        /// <summary>
        /// Returns true if V1PodTemplate instances are equal
        /// </summary>
        /// <param name="other">Instance of V1PodTemplate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1PodTemplate other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
