...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1PodTemplateList :  IEquatable<V1PodTemplateList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1PodTemplateList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1PodTemplateList() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1PodTemplateList" /> class.
        /// </summary>
        ...
        /// <param name="Items">List of pod templates (required).</param>
        ...
        public V1PodTemplateList(string ApiVersion = default(string), List<V1PodTemplate> Items = default(List<V1PodTemplate>), string Kind = default(string), UnversionedListMeta Metadata = default(UnversionedListMeta))
        {
            // to ensure "Items" is required (not null)
            if (Items == null)
            {
                throw new InvalidDataException("Items is a required property for V1PodTemplateList and cannot be null");
            }
            else
            {
                this.Items = Items;
        ...
        /// </summary>
        /// <value>List of pod templates</value>
        [DataMember(Name="items", EmitDefaultValue=false)]
        public List<V1PodTemplate> Items { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1PodTemplateList);
        }

        /// <summary>
        /// Returns true if V1PodTemplateList instances are equal
        /// </summary>
        /// <param name="other">Instance of V1PodTemplateList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1PodTemplateList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
