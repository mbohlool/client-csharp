...
namespace io.kubernetes.csharp.Model
{
    ...
    public partial class V1ReplicationControllerCondition :  IEquatable<V1ReplicationControllerCondition>, IValidatableObject
    {
        ...
        public V1ReplicationControllerCondition(UnversionedTime LastTransitionTime = default(UnversionedTime), string Message = default(string), string Reason = default(string), string Status = default(string), string Type = default(string))
        {
