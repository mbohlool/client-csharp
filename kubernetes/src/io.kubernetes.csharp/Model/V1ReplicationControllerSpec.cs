...
namespace io.kubernetes.csharp.Model
{
    ...
    public partial class V1ReplicationControllerSpec :  IEquatable<V1ReplicationControllerSpec>, IValidatableObject
    {
        ...
        /// <param name="Template">Template is the object that describes the pod that will be created if insufficient replicas are detected. This takes precedence over a TemplateRef. More info: http://kubernetes.io/docs/user-guide/replication-controller#pod-template.</param>
        ...
        /// </summary>
        /// <value>Template is the object that describes the pod that will be created if insufficient replicas are detected. This takes precedence over a TemplateRef. More info: http://kubernetes.io/docs/user-guide/replication-controller#pod-template</value>
