...
namespace io.kubernetes.csharp.Model
{
    ...
    public partial class V1ResourceQuota :  IEquatable<V1ResourceQuota>, IValidatableObject
    {
        ...
        /// <param name="Spec">Spec defines the desired quota. http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#spec-and-status.</param>
        /// <param name="Status">Status defines the actual enforced quota and its current usage. http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#spec-and-status.</param>
