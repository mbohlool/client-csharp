...
namespace io.kubernetes.csharp.Model
{
    ...
    public partial class V1ResourceQuotaSpec :  IEquatable<V1ResourceQuotaSpec>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="Hard">Hard is the set of desired hard limits for each named resource. More info: http://releases.k8s.io/HEAD/docs/design/admission_control_resource_quota.md#admissioncontrol-plugin-resourcequota.</param>
        ...
        public V1ResourceQuotaSpec(Dictionary<string, ResourceQuantity> Hard = default(Dictionary<string, ResourceQuantity>), List<string> Scopes = default(List<string>))
        {
            this.Hard = Hard;
            this.Scopes = Scopes;
        }
