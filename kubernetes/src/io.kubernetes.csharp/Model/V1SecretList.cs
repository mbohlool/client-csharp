...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1SecretList :  IEquatable<V1SecretList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1SecretList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1SecretList() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1SecretList" /> class.
        /// </summary>
        ...
        /// <param name="Items">Items is a list of secret objects. More info: http://kubernetes.io/docs/user-guide/secrets (required).</param>
        ...
        public V1SecretList(string ApiVersion = default(string), List<V1Secret> Items = default(List<V1Secret>), string Kind = default(string), UnversionedListMeta Metadata = default(UnversionedListMeta))
        {
            // to ensure "Items" is required (not null)
            if (Items == null)
            {
                throw new InvalidDataException("Items is a required property for V1SecretList and cannot be null");
            }
            else
            {
                this.Items = Items;
        ...
        /// </summary>
        /// <value>Items is a list of secret objects. More info: http://kubernetes.io/docs/user-guide/secrets</value>
        [DataMember(Name="items", EmitDefaultValue=false)]
        public List<V1Secret> Items { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1SecretList);
        }

        /// <summary>
        /// Returns true if V1SecretList instances are equal
        /// </summary>
        /// <param name="other">Instance of V1SecretList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1SecretList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
