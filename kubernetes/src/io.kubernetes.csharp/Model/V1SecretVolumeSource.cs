...
namespace io.kubernetes.csharp.Model
{
    ...
    public partial class V1SecretVolumeSource :  IEquatable<V1SecretVolumeSource>, IValidatableObject
    {
        ...
        /// <param name="SecretName">Name of the secret in the pod&#39;s namespace to use. More info: http://kubernetes.io/docs/user-guide/volumes#secrets.</param>
        public V1SecretVolumeSource(int? DefaultMode = default(int?), List<V1KeyToPath> Items = default(List<V1KeyToPath>), string SecretName = default(string))
        {
        ...
        /// </summary>
        /// <value>Name of the secret in the pod&#39;s namespace to use. More info: http://kubernetes.io/docs/user-guide/volumes#secrets</value>
