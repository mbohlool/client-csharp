...
namespace io.kubernetes.csharp.Model
{
    ...
    public partial class V1Service :  IEquatable<V1Service>, IValidatableObject
    {
        ...
        /// <param name="Spec">Spec defines the behavior of a service. http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#spec-and-status.</param>
        /// <param name="Status">Most recently observed status of the service. Populated by the system. Read-only. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#spec-and-status.</param>
        ...
        /// </summary>
        /// <value>Spec defines the behavior of a service. http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#spec-and-status</value>
        ...
        /// </summary>
        /// <value>Most recently observed status of the service. Populated by the system. Read-only. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#spec-and-status</value>
