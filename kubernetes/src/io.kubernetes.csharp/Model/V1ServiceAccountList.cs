...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1ServiceAccountList :  IEquatable<V1ServiceAccountList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1ServiceAccountList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1ServiceAccountList() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1ServiceAccountList" /> class.
        /// </summary>
        ...
        /// <param name="Items">List of ServiceAccounts. More info: http://releases.k8s.io/HEAD/docs/design/service_accounts.md#service-accounts (required).</param>
        ...
        public V1ServiceAccountList(string ApiVersion = default(string), List<V1ServiceAccount> Items = default(List<V1ServiceAccount>), string Kind = default(string), UnversionedListMeta Metadata = default(UnversionedListMeta))
        {
            // to ensure "Items" is required (not null)
            if (Items == null)
            {
                throw new InvalidDataException("Items is a required property for V1ServiceAccountList and cannot be null");
            }
            else
            {
                this.Items = Items;
        ...
        /// </summary>
        /// <value>List of ServiceAccounts. More info: http://releases.k8s.io/HEAD/docs/design/service_accounts.md#service-accounts</value>
        [DataMember(Name="items", EmitDefaultValue=false)]
        public List<V1ServiceAccount> Items { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1ServiceAccountList);
        }

        /// <summary>
        /// Returns true if V1ServiceAccountList instances are equal
        /// </summary>
        /// <param name="other">Instance of V1ServiceAccountList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1ServiceAccountList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
