...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1ServiceList :  IEquatable<V1ServiceList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1ServiceList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1ServiceList() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1ServiceList" /> class.
        /// </summary>
        ...
        /// <param name="Items">List of services (required).</param>
        ...
        public V1ServiceList(string ApiVersion = default(string), List<V1Service> Items = default(List<V1Service>), string Kind = default(string), UnversionedListMeta Metadata = default(UnversionedListMeta))
        {
            // to ensure "Items" is required (not null)
            if (Items == null)
            {
                throw new InvalidDataException("Items is a required property for V1ServiceList and cannot be null");
            }
            else
            {
                this.Items = Items;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1ServiceList);
        }

        /// <summary>
        /// Returns true if V1ServiceList instances are equal
        /// </summary>
        /// <param name="other">Instance of V1ServiceList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1ServiceList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
