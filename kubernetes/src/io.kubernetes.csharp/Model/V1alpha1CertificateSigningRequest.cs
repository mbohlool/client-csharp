...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1alpha1CertificateSigningRequest :  IEquatable<V1alpha1CertificateSigningRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The certificate request itself and any additional information.</value>
        [DataMember(Name="spec", EmitDefaultValue=false)]
        public V1alpha1CertificateSigningRequestSpec Spec { get; set; }
        /// <summary>
        /// Derived information about the request.
        /// </summary>
        /// <value>Derived information about the request.</value>
        [DataMember(Name="status", EmitDefaultValue=false)]
        public V1alpha1CertificateSigningRequestStatus Status { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1alpha1CertificateSigningRequest);
        }

        /// <summary>
        /// Returns true if V1alpha1CertificateSigningRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of V1alpha1CertificateSigningRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1alpha1CertificateSigningRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
