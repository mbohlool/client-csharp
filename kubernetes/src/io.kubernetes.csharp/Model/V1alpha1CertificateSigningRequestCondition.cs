...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1alpha1CertificateSigningRequestCondition :  IEquatable<V1alpha1CertificateSigningRequestCondition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1alpha1CertificateSigningRequestCondition" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1alpha1CertificateSigningRequestCondition() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1alpha1CertificateSigningRequestCondition" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1alpha1CertificateSigningRequestCondition);
        }

        /// <summary>
        /// Returns true if V1alpha1CertificateSigningRequestCondition instances are equal
        /// </summary>
        /// <param name="other">Instance of V1alpha1CertificateSigningRequestCondition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1alpha1CertificateSigningRequestCondition other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
