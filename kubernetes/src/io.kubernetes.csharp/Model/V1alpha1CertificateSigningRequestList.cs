...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1alpha1CertificateSigningRequestList :  IEquatable<V1alpha1CertificateSigningRequestList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1alpha1CertificateSigningRequestList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1alpha1CertificateSigningRequestList() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1alpha1CertificateSigningRequestList" /> class.
        /// </summary>
        ...
        public V1alpha1CertificateSigningRequestList(string ApiVersion = default(string), List<V1alpha1CertificateSigningRequest> Items = default(List<V1alpha1CertificateSigningRequest>), string Kind = default(string), UnversionedListMeta Metadata = default(UnversionedListMeta))
        {
            // to ensure "Items" is required (not null)
            if (Items == null)
            {
                throw new InvalidDataException("Items is a required property for V1alpha1CertificateSigningRequestList and cannot be null");
            }
            else
            {
                this.Items = Items;
        ...
        public List<V1alpha1CertificateSigningRequest> Items { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1alpha1CertificateSigningRequestList);
        }

        /// <summary>
        /// Returns true if V1alpha1CertificateSigningRequestList instances are equal
        /// </summary>
        /// <param name="other">Instance of V1alpha1CertificateSigningRequestList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1alpha1CertificateSigningRequestList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
