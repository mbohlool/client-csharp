...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1alpha1ClusterRole :  IEquatable<V1alpha1ClusterRole>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1alpha1ClusterRole" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1alpha1ClusterRole() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1alpha1ClusterRole" /> class.
        /// </summary>
        ...
        /// </summary>
        /// <value>Rules holds all the PolicyRules for this ClusterRole</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1alpha1ClusterRole);
        }

        /// <summary>
        /// Returns true if V1alpha1ClusterRole instances are equal
        /// </summary>
        /// <param name="other">Instance of V1alpha1ClusterRole to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1alpha1ClusterRole other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
