...
namespace io.kubernetes.csharp.Model
{
    ...
    public partial class V1alpha1PolicyRule :  IEquatable<V1alpha1PolicyRule>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>AttributeRestrictions will vary depending on what the Authorizer/AuthorizationAttributeBuilder pair supports. If the Authorizer does not recognize how to handle the AttributeRestrictions, the Authorizer should report an error.</value>
        [DataMember(Name="attributeRestrictions", EmitDefaultValue=false)]
        public RuntimeRawExtension AttributeRestrictions { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AttributeRestrictions: ").Append(AttributeRestrictions).Append("\n");
        ...
        public bool Equals(V1alpha1PolicyRule other)
        {
            ...
            return 
                ...
                (
                    this.AttributeRestrictions == other.AttributeRestrictions ||
                    this.AttributeRestrictions != null &&
                    this.AttributeRestrictions.Equals(other.AttributeRestrictions)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AttributeRestrictions != null)
                    hash = hash * 59 + this.AttributeRestrictions.GetHashCode();
