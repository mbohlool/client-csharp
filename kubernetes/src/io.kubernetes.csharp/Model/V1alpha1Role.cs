...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1alpha1Role :  IEquatable<V1alpha1Role>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1alpha1Role" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1alpha1Role() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1alpha1Role" /> class.
        /// </summary>
        ...
        public V1alpha1Role(string ApiVersion = default(string), string Kind = default(string), V1ObjectMeta Metadata = default(V1ObjectMeta), List<V1alpha1PolicyRule> Rules = default(List<V1alpha1PolicyRule>))
        {
            // to ensure "Rules" is required (not null)
            if (Rules == null)
            {
                throw new InvalidDataException("Rules is a required property for V1alpha1Role and cannot be null");
            }
            else
            {
                this.Rules = Rules;
        ...
        public List<V1alpha1PolicyRule> Rules { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1alpha1Role);
        }

        /// <summary>
        /// Returns true if V1alpha1Role instances are equal
        /// </summary>
        /// <param name="other">Instance of V1alpha1Role to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1alpha1Role other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
