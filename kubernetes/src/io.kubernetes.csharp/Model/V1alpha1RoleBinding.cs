...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1alpha1RoleBinding :  IEquatable<V1alpha1RoleBinding>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1alpha1RoleBinding" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1alpha1RoleBinding() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1alpha1RoleBinding" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1alpha1RoleBinding);
        }

        /// <summary>
        /// Returns true if V1alpha1RoleBinding instances are equal
        /// </summary>
        /// <param name="other">Instance of V1alpha1RoleBinding to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1alpha1RoleBinding other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
