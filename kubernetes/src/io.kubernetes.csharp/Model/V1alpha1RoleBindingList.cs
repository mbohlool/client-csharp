...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1alpha1RoleBindingList :  IEquatable<V1alpha1RoleBindingList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1alpha1RoleBindingList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1alpha1RoleBindingList() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1alpha1RoleBindingList" /> class.
        /// </summary>
        ...
        /// <param name="Items">Items is a list of RoleBindings (required).</param>
        ...
        public V1alpha1RoleBindingList(string ApiVersion = default(string), List<V1alpha1RoleBinding> Items = default(List<V1alpha1RoleBinding>), string Kind = default(string), UnversionedListMeta Metadata = default(UnversionedListMeta))
        {
            // to ensure "Items" is required (not null)
            if (Items == null)
            {
                throw new InvalidDataException("Items is a required property for V1alpha1RoleBindingList and cannot be null");
            }
            else
            {
                this.Items = Items;
        ...
        /// </summary>
        /// <value>Items is a list of RoleBindings</value>
        [DataMember(Name="items", EmitDefaultValue=false)]
        public List<V1alpha1RoleBinding> Items { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1alpha1RoleBindingList);
        }

        /// <summary>
        /// Returns true if V1alpha1RoleBindingList instances are equal
        /// </summary>
        /// <param name="other">Instance of V1alpha1RoleBindingList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1alpha1RoleBindingList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
