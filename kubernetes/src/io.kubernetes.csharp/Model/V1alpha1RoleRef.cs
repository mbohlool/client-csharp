...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1alpha1RoleRef :  IEquatable<V1alpha1RoleRef>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1alpha1RoleRef" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1alpha1RoleRef() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1alpha1RoleRef" /> class.
        /// </summary>
        ...
        public V1alpha1RoleRef(string ApiGroup = default(string), string Kind = default(string), string Name = default(string))
        {
            // to ensure "ApiGroup" is required (not null)
            if (ApiGroup == null)
            {
                throw new InvalidDataException("ApiGroup is a required property for V1alpha1RoleRef and cannot be null");
            }
            else
            {
            ...
            if (Kind == null)
            {
                throw new InvalidDataException("Kind is a required property for V1alpha1RoleRef and cannot be null");
            }
            else
            {
                this.Kind = Kind;
            ...
            if (Name == null)
            {
                throw new InvalidDataException("Name is a required property for V1alpha1RoleRef and cannot be null");
            }
            else
            {
                this.Name = Name;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1alpha1RoleRef);
        }

        /// <summary>
        /// Returns true if V1alpha1RoleRef instances are equal
        /// </summary>
        /// <param name="other">Instance of V1alpha1RoleRef to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1alpha1RoleRef other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
