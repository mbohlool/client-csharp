...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1beta1DaemonSetList :  IEquatable<V1beta1DaemonSetList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1beta1DaemonSetList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1beta1DaemonSetList() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1beta1DaemonSetList" /> class.
        /// </summary>
        ...
        /// <param name="Items">Items is a list of daemon sets. (required).</param>
        ...
        public V1beta1DaemonSetList(string ApiVersion = default(string), List<V1beta1DaemonSet> Items = default(List<V1beta1DaemonSet>), string Kind = default(string), UnversionedListMeta Metadata = default(UnversionedListMeta))
        {
            // to ensure "Items" is required (not null)
            if (Items == null)
            {
                throw new InvalidDataException("Items is a required property for V1beta1DaemonSetList and cannot be null");
            }
            else
            {
                this.Items = Items;
        ...
        /// </summary>
        /// <value>Items is a list of daemon sets.</value>
        [DataMember(Name="items", EmitDefaultValue=false)]
        public List<V1beta1DaemonSet> Items { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1beta1DaemonSetList);
        }

        /// <summary>
        /// Returns true if V1beta1DaemonSetList instances are equal
        /// </summary>
        /// <param name="other">Instance of V1beta1DaemonSetList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1beta1DaemonSetList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
