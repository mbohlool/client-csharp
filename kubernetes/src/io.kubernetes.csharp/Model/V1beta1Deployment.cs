...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1beta1Deployment :  IEquatable<V1beta1Deployment>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1beta1Deployment" /> class.
        /// </summary>
        ...
        public V1beta1Deployment(string ApiVersion = default(string), string Kind = default(string), V1ObjectMeta Metadata = default(V1ObjectMeta), V1beta1DeploymentSpec Spec = default(V1beta1DeploymentSpec), V1beta1DeploymentStatus Status = default(V1beta1DeploymentStatus))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1beta1Deployment);
        }

        /// <summary>
        /// Returns true if V1beta1Deployment instances are equal
        /// </summary>
        /// <param name="other">Instance of V1beta1Deployment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1beta1Deployment other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
