...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1beta1DeploymentCondition :  IEquatable<V1beta1DeploymentCondition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1beta1DeploymentCondition" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1beta1DeploymentCondition() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1beta1DeploymentCondition" /> class.
        /// </summary>
        ...
        public V1beta1DeploymentCondition(UnversionedTime LastTransitionTime = default(UnversionedTime), UnversionedTime LastUpdateTime = default(UnversionedTime), string Message = default(string), string Reason = default(string), string Status = default(string), string Type = default(string))
        {
            // to ensure "Status" is required (not null)
            if (Status == null)
            {
                throw new InvalidDataException("Status is a required property for V1beta1DeploymentCondition and cannot be null");
            }
            else
            {
                this.Status = Status;
            ...
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for V1beta1DeploymentCondition and cannot be null");
            }
            else
            {
                this.Type = Type;
        ...
        public UnversionedTime LastUpdateTime { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1beta1DeploymentCondition);
        }

        /// <summary>
        /// Returns true if V1beta1DeploymentCondition instances are equal
        /// </summary>
        /// <param name="other">Instance of V1beta1DeploymentCondition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1beta1DeploymentCondition other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
