...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1beta1DeploymentList :  IEquatable<V1beta1DeploymentList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1beta1DeploymentList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1beta1DeploymentList() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1beta1DeploymentList" /> class.
        /// </summary>
        ...
        public V1beta1DeploymentList(string ApiVersion = default(string), List<V1beta1Deployment> Items = default(List<V1beta1Deployment>), string Kind = default(string), UnversionedListMeta Metadata = default(UnversionedListMeta))
        {
            // to ensure "Items" is required (not null)
            if (Items == null)
            {
                throw new InvalidDataException("Items is a required property for V1beta1DeploymentList and cannot be null");
            }
            else
            {
                this.Items = Items;
        ...
        public List<V1beta1Deployment> Items { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1beta1DeploymentList);
        }

        /// <summary>
        /// Returns true if V1beta1DeploymentList instances are equal
        /// </summary>
        /// <param name="other">Instance of V1beta1DeploymentList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1beta1DeploymentList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
