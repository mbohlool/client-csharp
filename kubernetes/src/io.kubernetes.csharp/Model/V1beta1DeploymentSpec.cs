...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1beta1DeploymentSpec :  IEquatable<V1beta1DeploymentSpec>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1beta1DeploymentSpec" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1beta1DeploymentSpec() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1beta1DeploymentSpec" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1beta1DeploymentSpec);
        }

        /// <summary>
        /// Returns true if V1beta1DeploymentSpec instances are equal
        /// </summary>
        /// <param name="other">Instance of V1beta1DeploymentSpec to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1beta1DeploymentSpec other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
