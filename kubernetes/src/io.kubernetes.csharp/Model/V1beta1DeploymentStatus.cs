...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1beta1DeploymentStatus :  IEquatable<V1beta1DeploymentStatus>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1beta1DeploymentStatus" /> class.
        /// </summary>
        ...
        public V1beta1DeploymentStatus(int? AvailableReplicas = default(int?), List<V1beta1DeploymentCondition> Conditions = default(List<V1beta1DeploymentCondition>), long? ObservedGeneration = default(long?), int? Replicas = default(int?), int? UnavailableReplicas = default(int?), int? UpdatedReplicas = default(int?))
        {
        ...
        public List<V1beta1DeploymentCondition> Conditions { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1beta1DeploymentStatus);
        }

        /// <summary>
        /// Returns true if V1beta1DeploymentStatus instances are equal
        /// </summary>
        /// <param name="other">Instance of V1beta1DeploymentStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1beta1DeploymentStatus other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
