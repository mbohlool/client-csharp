...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1beta1HorizontalPodAutoscaler :  IEquatable<V1beta1HorizontalPodAutoscaler>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1beta1HorizontalPodAutoscaler" /> class.
        /// </summary>
        ...
        /// <param name="Spec">behaviour of autoscaler. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#spec-and-status..</param>
        /// <param name="Status">current information about the autoscaler..</param>
        public V1beta1HorizontalPodAutoscaler(string ApiVersion = default(string), string Kind = default(string), V1ObjectMeta Metadata = default(V1ObjectMeta), V1beta1HorizontalPodAutoscalerSpec Spec = default(V1beta1HorizontalPodAutoscalerSpec), V1beta1HorizontalPodAutoscalerStatus Status = default(V1beta1HorizontalPodAutoscalerStatus))
        {
        ...
        public V1beta1HorizontalPodAutoscalerSpec Spec { get; set; }
        /// <summary>
        /// current information about the autoscaler.
        /// </summary>
        /// <value>current information about the autoscaler.</value>
        [DataMember(Name="status", EmitDefaultValue=false)]
        public V1beta1HorizontalPodAutoscalerStatus Status { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1beta1HorizontalPodAutoscaler);
        }

        /// <summary>
        /// Returns true if V1beta1HorizontalPodAutoscaler instances are equal
        /// </summary>
        /// <param name="other">Instance of V1beta1HorizontalPodAutoscaler to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1beta1HorizontalPodAutoscaler other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
