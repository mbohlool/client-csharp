...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1beta1HorizontalPodAutoscalerStatus :  IEquatable<V1beta1HorizontalPodAutoscalerStatus>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1beta1HorizontalPodAutoscalerStatus" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1beta1HorizontalPodAutoscalerStatus() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1beta1HorizontalPodAutoscalerStatus" /> class.
        /// </summary>
        ...
        public UnversionedTime LastScaleTime { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1beta1HorizontalPodAutoscalerStatus);
        }

        /// <summary>
        /// Returns true if V1beta1HorizontalPodAutoscalerStatus instances are equal
        /// </summary>
        /// <param name="other">Instance of V1beta1HorizontalPodAutoscalerStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1beta1HorizontalPodAutoscalerStatus other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
