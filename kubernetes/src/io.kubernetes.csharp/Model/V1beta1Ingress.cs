...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1beta1Ingress :  IEquatable<V1beta1Ingress>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1beta1Ingress" /> class.
        /// </summary>
        ...
        /// <param name="Spec">Spec is the desired state of the Ingress. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#spec-and-status.</param>
        /// <param name="Status">Status is the current state of the Ingress. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#spec-and-status.</param>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1beta1Ingress);
        }

        /// <summary>
        /// Returns true if V1beta1Ingress instances are equal
        /// </summary>
        /// <param name="other">Instance of V1beta1Ingress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1beta1Ingress other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
