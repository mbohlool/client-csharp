...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1beta1IngressList :  IEquatable<V1beta1IngressList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1beta1IngressList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1beta1IngressList() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1beta1IngressList" /> class.
        /// </summary>
        ...
        /// <param name="Items">Items is the list of Ingress. (required).</param>
        ...
        public V1beta1IngressList(string ApiVersion = default(string), List<V1beta1Ingress> Items = default(List<V1beta1Ingress>), string Kind = default(string), UnversionedListMeta Metadata = default(UnversionedListMeta))
        {
            // to ensure "Items" is required (not null)
            if (Items == null)
            {
                throw new InvalidDataException("Items is a required property for V1beta1IngressList and cannot be null");
            }
            else
            {
                this.Items = Items;
        ...
        /// </summary>
        /// <value>Items is the list of Ingress.</value>
        [DataMember(Name="items", EmitDefaultValue=false)]
        public List<V1beta1Ingress> Items { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1beta1IngressList);
        }

        /// <summary>
        /// Returns true if V1beta1IngressList instances are equal
        /// </summary>
        /// <param name="other">Instance of V1beta1IngressList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1beta1IngressList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
