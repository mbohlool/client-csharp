...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1beta1Job :  IEquatable<V1beta1Job>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1beta1Job" /> class.
        /// </summary>
        ...
        public V1beta1Job(string ApiVersion = default(string), string Kind = default(string), V1ObjectMeta Metadata = default(V1ObjectMeta), V1beta1JobSpec Spec = default(V1beta1JobSpec), V1beta1JobStatus Status = default(V1beta1JobStatus))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1beta1Job);
        }

        /// <summary>
        /// Returns true if V1beta1Job instances are equal
        /// </summary>
        /// <param name="other">Instance of V1beta1Job to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1beta1Job other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
