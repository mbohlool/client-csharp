...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1beta1JobStatus :  IEquatable<V1beta1JobStatus>, IValidatableObject
    {
        /// <summary>
        ...
        public List<V1beta1JobCondition> Conditions { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1beta1JobStatus);
        }

        /// <summary>
        /// Returns true if V1beta1JobStatus instances are equal
        /// </summary>
        /// <param name="other">Instance of V1beta1JobStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1beta1JobStatus other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
