...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1beta1LocalSubjectAccessReview :  IEquatable<V1beta1LocalSubjectAccessReview>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1beta1LocalSubjectAccessReview" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1beta1LocalSubjectAccessReview() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1beta1LocalSubjectAccessReview" /> class.
        /// </summary>
        ...
        public V1beta1LocalSubjectAccessReview(string ApiVersion = default(string), string Kind = default(string), V1ObjectMeta Metadata = default(V1ObjectMeta), V1beta1SubjectAccessReviewSpec Spec = default(V1beta1SubjectAccessReviewSpec), V1beta1SubjectAccessReviewStatus Status = default(V1beta1SubjectAccessReviewStatus))
        {
            // to ensure "Spec" is required (not null)
            if (Spec == null)
            {
                throw new InvalidDataException("Spec is a required property for V1beta1LocalSubjectAccessReview and cannot be null");
            }
            else
            {
                this.Spec = Spec;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1beta1LocalSubjectAccessReview);
        }

        /// <summary>
        /// Returns true if V1beta1LocalSubjectAccessReview instances are equal
        /// </summary>
        /// <param name="other">Instance of V1beta1LocalSubjectAccessReview to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1beta1LocalSubjectAccessReview other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
