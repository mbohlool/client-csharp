...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1beta1NetworkPolicy :  IEquatable<V1beta1NetworkPolicy>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Specification of the desired behavior for this NetworkPolicy.</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1beta1NetworkPolicy);
        }

        /// <summary>
        /// Returns true if V1beta1NetworkPolicy instances are equal
        /// </summary>
        /// <param name="other">Instance of V1beta1NetworkPolicy to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1beta1NetworkPolicy other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
