...
namespace io.kubernetes.csharp.Model
{
    ...
    public partial class V1beta1NetworkPolicyList :  IEquatable<V1beta1NetworkPolicyList>, IValidatableObject
    {
        ...
        public V1beta1NetworkPolicyList(string ApiVersion = default(string), List<V1beta1NetworkPolicy> Items = default(List<V1beta1NetworkPolicy>), string Kind = default(string), UnversionedListMeta Metadata = default(UnversionedListMeta))
        {
