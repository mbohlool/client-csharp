...
namespace io.kubernetes.csharp.Model
{
    ...
    public partial class V1beta1PodDisruptionBudgetList :  IEquatable<V1beta1PodDisruptionBudgetList>, IValidatableObject
    {
        ...
        public V1beta1PodDisruptionBudgetList(string ApiVersion = default(string), List<V1beta1PodDisruptionBudget> Items = default(List<V1beta1PodDisruptionBudget>), string Kind = default(string), UnversionedListMeta Metadata = default(UnversionedListMeta))
        {
