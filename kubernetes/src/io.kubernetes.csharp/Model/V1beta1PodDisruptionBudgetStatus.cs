...
namespace io.kubernetes.csharp.Model
{
    ...
    public partial class V1beta1PodDisruptionBudgetStatus :  IEquatable<V1beta1PodDisruptionBudgetStatus>, IValidatableObject
    {
        ...
        public V1beta1PodDisruptionBudgetStatus(int? CurrentHealthy = default(int?), int? DesiredHealthy = default(int?), Dictionary<string, UnversionedTime> DisruptedPods = default(Dictionary<string, UnversionedTime>), int? DisruptionsAllowed = default(int?), int? ExpectedPods = default(int?), long? ObservedGeneration = default(long?))
        {
        ...
        public Dictionary<string, UnversionedTime> DisruptedPods { get; set; }
        /// <summary>
