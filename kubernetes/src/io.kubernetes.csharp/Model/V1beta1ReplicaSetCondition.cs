...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1beta1ReplicaSetCondition :  IEquatable<V1beta1ReplicaSetCondition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1beta1ReplicaSetCondition" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1beta1ReplicaSetCondition() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1beta1ReplicaSetCondition" /> class.
        /// </summary>
        ...
        /// <param name="Type">Type of replica set condition. (required).</param>
        public V1beta1ReplicaSetCondition(UnversionedTime LastTransitionTime = default(UnversionedTime), string Message = default(string), string Reason = default(string), string Status = default(string), string Type = default(string))
        {
            // to ensure "Status" is required (not null)
            if (Status == null)
            {
                throw new InvalidDataException("Status is a required property for V1beta1ReplicaSetCondition and cannot be null");
            }
            else
            {
                this.Status = Status;
            ...
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for V1beta1ReplicaSetCondition and cannot be null");
            }
            else
            {
                this.Type = Type;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1beta1ReplicaSetCondition);
        }

        /// <summary>
        /// Returns true if V1beta1ReplicaSetCondition instances are equal
        /// </summary>
        /// <param name="other">Instance of V1beta1ReplicaSetCondition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1beta1ReplicaSetCondition other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
