...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1beta1ReplicaSetList :  IEquatable<V1beta1ReplicaSetList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1beta1ReplicaSetList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1beta1ReplicaSetList() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1beta1ReplicaSetList" /> class.
        /// </summary>
        ...
        /// <param name="Items">List of ReplicaSets. More info: http://kubernetes.io/docs/user-guide/replication-controller (required).</param>
        ...
        public V1beta1ReplicaSetList(string ApiVersion = default(string), List<V1beta1ReplicaSet> Items = default(List<V1beta1ReplicaSet>), string Kind = default(string), UnversionedListMeta Metadata = default(UnversionedListMeta))
        {
            // to ensure "Items" is required (not null)
            if (Items == null)
            {
                throw new InvalidDataException("Items is a required property for V1beta1ReplicaSetList and cannot be null");
            }
            else
            {
                this.Items = Items;
        ...
        /// </summary>
        /// <value>List of ReplicaSets. More info: http://kubernetes.io/docs/user-guide/replication-controller</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1beta1ReplicaSetList);
        }

        /// <summary>
        /// Returns true if V1beta1ReplicaSetList instances are equal
        /// </summary>
        /// <param name="other">Instance of V1beta1ReplicaSetList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1beta1ReplicaSetList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
