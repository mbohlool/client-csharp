...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1beta1ResourceAttributes :  IEquatable<V1beta1ResourceAttributes>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1beta1ResourceAttributes" /> class.
        /// </summary>
        ...
        public V1beta1ResourceAttributes(string Group = default(string), string Name = default(string), string _Namespace = default(string), string Resource = default(string), string Subresource = default(string), string Verb = default(string), string Version = default(string))
        {
            this.Group = Group;
            this.Name = Name;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1beta1ResourceAttributes);
        }

        /// <summary>
        /// Returns true if V1beta1ResourceAttributes instances are equal
        /// </summary>
        /// <param name="other">Instance of V1beta1ResourceAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1beta1ResourceAttributes other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
