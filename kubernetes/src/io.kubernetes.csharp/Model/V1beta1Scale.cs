...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1beta1Scale :  IEquatable<V1beta1Scale>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1beta1Scale" /> class.
        /// </summary>
        ...
        public V1beta1Scale(string ApiVersion = default(string), string Kind = default(string), V1ObjectMeta Metadata = default(V1ObjectMeta), V1beta1ScaleSpec Spec = default(V1beta1ScaleSpec), V1beta1ScaleStatus Status = default(V1beta1ScaleStatus))
        {
        ...
        public V1beta1ScaleSpec Spec { get; set; }
        /// <summary>
        ...
        public V1beta1ScaleStatus Status { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1beta1Scale);
        }

        /// <summary>
        /// Returns true if V1beta1Scale instances are equal
        /// </summary>
        /// <param name="other">Instance of V1beta1Scale to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1beta1Scale other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
