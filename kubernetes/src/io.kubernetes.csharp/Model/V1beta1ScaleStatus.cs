...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1beta1ScaleStatus :  IEquatable<V1beta1ScaleStatus>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1beta1ScaleStatus" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1beta1ScaleStatus() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1beta1ScaleStatus" /> class.
        /// </summary>
        ...
        public V1beta1ScaleStatus(int? Replicas = default(int?), Dictionary<string, string> Selector = default(Dictionary<string, string>), string TargetSelector = default(string))
        {
            // to ensure "Replicas" is required (not null)
            if (Replicas == null)
            {
                throw new InvalidDataException("Replicas is a required property for V1beta1ScaleStatus and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1beta1ScaleStatus);
        }

        /// <summary>
        /// Returns true if V1beta1ScaleStatus instances are equal
        /// </summary>
        /// <param name="other">Instance of V1beta1ScaleStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1beta1ScaleStatus other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
