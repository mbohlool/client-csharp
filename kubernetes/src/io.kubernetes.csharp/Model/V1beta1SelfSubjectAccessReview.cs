...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1beta1SelfSubjectAccessReview :  IEquatable<V1beta1SelfSubjectAccessReview>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1beta1SelfSubjectAccessReview" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1beta1SelfSubjectAccessReview() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1beta1SelfSubjectAccessReview" /> class.
        /// </summary>
        ...
        /// <param name="Spec">Spec holds information about the request being evaluated.  user and groups must be empty (required).</param>
        /// <param name="Status">Status is filled in by the server and indicates whether the request is allowed or not.</param>
        public V1beta1SelfSubjectAccessReview(string ApiVersion = default(string), string Kind = default(string), V1ObjectMeta Metadata = default(V1ObjectMeta), V1beta1SelfSubjectAccessReviewSpec Spec = default(V1beta1SelfSubjectAccessReviewSpec), V1beta1SubjectAccessReviewStatus Status = default(V1beta1SubjectAccessReviewStatus))
        {
            // to ensure "Spec" is required (not null)
            if (Spec == null)
            {
                throw new InvalidDataException("Spec is a required property for V1beta1SelfSubjectAccessReview and cannot be null");
            }
            else
            {
                this.Spec = Spec;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1beta1SelfSubjectAccessReview);
        }

        /// <summary>
        /// Returns true if V1beta1SelfSubjectAccessReview instances are equal
        /// </summary>
        /// <param name="other">Instance of V1beta1SelfSubjectAccessReview to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1beta1SelfSubjectAccessReview other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
