...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1beta1StorageClassList :  IEquatable<V1beta1StorageClassList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1beta1StorageClassList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1beta1StorageClassList() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1beta1StorageClassList" /> class.
        /// </summary>
        ...
        /// <param name="Items">Items is the list of StorageClasses (required).</param>
        ...
        /// <param name="Metadata">Standard list metadata More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#metadata.</param>
        public V1beta1StorageClassList(string ApiVersion = default(string), List<V1beta1StorageClass> Items = default(List<V1beta1StorageClass>), string Kind = default(string), UnversionedListMeta Metadata = default(UnversionedListMeta))
        {
            // to ensure "Items" is required (not null)
            if (Items == null)
            {
                throw new InvalidDataException("Items is a required property for V1beta1StorageClassList and cannot be null");
            }
            else
            {
                this.Items = Items;
        ...
        /// </summary>
        /// <value>Items is the list of StorageClasses</value>
        [DataMember(Name="items", EmitDefaultValue=false)]
        public List<V1beta1StorageClass> Items { get; set; }
        /// <summary>
        ...
        /// </summary>
        /// <value>Standard list metadata More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#metadata</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1beta1StorageClassList);
        }

        /// <summary>
        /// Returns true if V1beta1StorageClassList instances are equal
        /// </summary>
        /// <param name="other">Instance of V1beta1StorageClassList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1beta1StorageClassList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
