...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1beta1ThirdPartyResourceList :  IEquatable<V1beta1ThirdPartyResourceList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1beta1ThirdPartyResourceList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1beta1ThirdPartyResourceList() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1beta1ThirdPartyResourceList" /> class.
        /// </summary>
        ...
        /// <param name="Items">Items is the list of ThirdPartyResources. (required).</param>
        ...
        public V1beta1ThirdPartyResourceList(string ApiVersion = default(string), List<V1beta1ThirdPartyResource> Items = default(List<V1beta1ThirdPartyResource>), string Kind = default(string), UnversionedListMeta Metadata = default(UnversionedListMeta))
        {
            // to ensure "Items" is required (not null)
            if (Items == null)
            {
                throw new InvalidDataException("Items is a required property for V1beta1ThirdPartyResourceList and cannot be null");
            }
            else
            {
                this.Items = Items;
        ...
        public List<V1beta1ThirdPartyResource> Items { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1beta1ThirdPartyResourceList);
        }

        /// <summary>
        /// Returns true if V1beta1ThirdPartyResourceList instances are equal
        /// </summary>
        /// <param name="other">Instance of V1beta1ThirdPartyResourceList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1beta1ThirdPartyResourceList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
