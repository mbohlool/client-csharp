...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1beta1TokenReview :  IEquatable<V1beta1TokenReview>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1beta1TokenReview" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1beta1TokenReview() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1beta1TokenReview" /> class.
        /// </summary>
        ...
        /// <param name="Status">Status is filled in by the server and indicates whether the request can be authenticated..</param>
        public V1beta1TokenReview(string ApiVersion = default(string), string Kind = default(string), V1ObjectMeta Metadata = default(V1ObjectMeta), V1beta1TokenReviewSpec Spec = default(V1beta1TokenReviewSpec), V1beta1TokenReviewStatus Status = default(V1beta1TokenReviewStatus))
        {
            // to ensure "Spec" is required (not null)
            if (Spec == null)
            {
                throw new InvalidDataException("Spec is a required property for V1beta1TokenReview and cannot be null");
            }
            else
            {
                this.Spec = Spec;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1beta1TokenReview);
        }

        /// <summary>
        /// Returns true if V1beta1TokenReview instances are equal
        /// </summary>
        /// <param name="other">Instance of V1beta1TokenReview to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1beta1TokenReview other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
