...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2alpha1CronJob :  IEquatable<V2alpha1CronJob>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="Spec">Spec is a structure defining the expected behavior of a job, including the schedule. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#spec-and-status.</param>
        ...
        /// </summary>
        /// <value>Spec is a structure defining the expected behavior of a job, including the schedule. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#spec-and-status</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2alpha1CronJob);
        }

        /// <summary>
        /// Returns true if V2alpha1CronJob instances are equal
        /// </summary>
        /// <param name="other">Instance of V2alpha1CronJob to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2alpha1CronJob other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
