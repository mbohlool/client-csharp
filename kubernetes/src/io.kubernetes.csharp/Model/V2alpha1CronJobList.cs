...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2alpha1CronJobList :  IEquatable<V2alpha1CronJobList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2alpha1CronJobList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V2alpha1CronJobList() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V2alpha1CronJobList" /> class.
        /// </summary>
        ...
        /// <param name="Items">Items is the list of CronJob. (required).</param>
        ...
        public V2alpha1CronJobList(string ApiVersion = default(string), List<V2alpha1CronJob> Items = default(List<V2alpha1CronJob>), string Kind = default(string), UnversionedListMeta Metadata = default(UnversionedListMeta))
        {
            // to ensure "Items" is required (not null)
            if (Items == null)
            {
                throw new InvalidDataException("Items is a required property for V2alpha1CronJobList and cannot be null");
            }
            else
            {
                this.Items = Items;
        ...
        /// </summary>
        /// <value>Items is the list of CronJob.</value>
        [DataMember(Name="items", EmitDefaultValue=false)]
        public List<V2alpha1CronJob> Items { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2alpha1CronJobList);
        }

        /// <summary>
        /// Returns true if V2alpha1CronJobList instances are equal
        /// </summary>
        /// <param name="other">Instance of V2alpha1CronJobList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2alpha1CronJobList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
