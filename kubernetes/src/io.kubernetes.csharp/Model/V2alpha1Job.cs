...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2alpha1Job :  IEquatable<V2alpha1Job>, IValidatableObject
    {
        /// <summary>
        ...
        public V2alpha1JobSpec Spec { get; set; }
        /// <summary>
        ...
        public V2alpha1JobStatus Status { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2alpha1Job);
        }

        /// <summary>
        /// Returns true if V2alpha1Job instances are equal
        /// </summary>
        /// <param name="other">Instance of V2alpha1Job to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2alpha1Job other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
