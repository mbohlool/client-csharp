...
namespace io.kubernetes.csharp.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2alpha1JobList :  IEquatable<V2alpha1JobList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2alpha1JobList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V2alpha1JobList() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V2alpha1JobList" /> class.
        /// </summary>
        ...
        /// <param name="Items">Items is the list of Job. (required).</param>
        ...
        public V2alpha1JobList(string ApiVersion = default(string), List<V2alpha1Job> Items = default(List<V2alpha1Job>), string Kind = default(string), UnversionedListMeta Metadata = default(UnversionedListMeta))
        {
            // to ensure "Items" is required (not null)
            if (Items == null)
            {
                throw new InvalidDataException("Items is a required property for V2alpha1JobList and cannot be null");
            }
            else
            {
                this.Items = Items;
        ...
        /// </summary>
        /// <value>Items is the list of Job.</value>
        [DataMember(Name="items", EmitDefaultValue=false)]
        public List<V2alpha1Job> Items { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2alpha1JobList);
        }

        /// <summary>
        /// Returns true if V2alpha1JobList instances are equal
        /// </summary>
        /// <param name="other">Instance of V2alpha1JobList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2alpha1JobList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
